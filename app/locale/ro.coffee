module.exports = nativeDescription: "limba română", englishDescription: "Romanian", translation:
  ...
  new_home:
#    title: "CodeCombat - Invata sa programezi Python and JavaScript prin jocuri"
#    meta_keywords: "CodeCombat, python, javascript, Coding Games"
#    meta_description: "Invata sa scrii cod jucand un joc. Invata Python, JavaScript, si HTML rezolvand puzzle si invatati sa va creati propriile jocuri de cod si site-uri web."
#    meta_og_url: "https://codecombat.com"
#    become_investor: "pentru a deveni investitor in CodeCombat"
    built_for_teachers_title: "Un joc de programare dezvoltat cu gandul la profesori."
#    built_for_teachers_blurb: "Invatarea copiilor sa codeze poate parea adesea copleșitoare. CodeCombat ajuta toti profesorii sa învete elevii cum sa scrie cod in JavaScript si / sau Python, doua dintre cele mai populare limbaje de programare. Cu o programa cuprinzatoare care include 6 module de informatica si care imbunatateste invatarea prin dezvoltarea de jocuri bazate pe proiecte si module de dezvoltare web, copiii vor progresa intr-o calatorie de la sintaxa de baza la recursivitate!"
...
#    built_for_teachers_subblurb2: "Cursantii construiesc labirinturi si utilizeaza manipularea de baza a intrarilor pentru a-si scrie codul propriilor jocuri care pot fi partajate cu prietenii si familia."
    built_for_teachers_subtitle3: "Dezvoltare Web"
#    built_for_teachers_subblurb3: "Folosind HTML, CSS si jQuery, cursantii isi "incordeaza muschii creativi" pentru a-si programa propriile pagini web cu o adresa URL personalizata pentru a le impartasi colegilor de clasa."
#    century_skills_title: "Abilitatile secolului XXI"
#    century_skills_blurb1: "Studentii / elevii nu doar isi ridica nivelul eroului, ci se ridica la nivelul lor"
#    century_skills_quote1: "Te dezordinezi ... deci te gandesti la toate modalitatile posibile de a remedia problema, apoi incearca din nou. Nu as putea ajunge aici fara sa ma straduiesc din greu."
    century_skills_subtitle1: "Gândire critică"
#    century_skills_subblurb1: "Cu puzzle-uri de codare care sunt în mod natural ridicate în nivele din ce în ce mai provocatoare, jocul de programare al CodeCombat asigură intotdeauna copiilor practicarea gandirii critice."
#    century_skills_quote2: "Toti ceilalți faceau labirinturi, asa ca m-am gandit „capteaza steagul” si asta am facut."
    century_skills_subtitle2: "Creativitate"
#    century_skills_subblurb2: "CodeCombat incurajeaza elevii sa-si prezinte creativitatea prin construirea si partajarea propriilor lor jocuri si pagini web."
#    century_skills_quote3: "Daca m-as blocat la un nivel... As lucra cu oamenii din jurul meu pana vom reusi cu totii sa ne dam seama ce e de facut."
#    century_skills_subtitle3: "Colaborare"
#    century_skills_subblurb3: "De-a lungul jocului, exista oportunitati pentru studenti/elevi de a colabora atunci cand se blocheaza si de a lucra impreuna folosind ghidul nostru de programare pereche."
#    century_skills_quote4: "Mereu mi-am dorit sa stiu sa proiectez jocuri video si sa învat cum sa codez ... acest lucru imi ofera un punct de plecare excelent."
#    century_skills_subtitle4: "Comunicare"
#    century_skills_subblurb4: "Scrierea de cod sursa impune copiilor sa practice noi forme de comunicare, inclusiv comunicarea cu computerul și transmiterea ideilor lor folosind cel mai eficient cod."
#    classroom_in_box_title: "Ne straduim sa:"
#    classroom_in_box_blurb1: "Atragem elevii/studentii, astfel încat sa fie convinsi ca scrierea de cod sursa este pentru ei."
#    classroom_in_box_blurb2: "Sustinem orice educator sa se simta increzator atunci cand preda scrierea de cod sursa."
#    classroom_in_box_blurb3: "Inspiraa toti liderii scolii sa creeze un program de informatica de talie mondiala."
#    classroom_in_box_blurb4: ""
#    covid19_banner_blurb: "Oferim acces gratuit la programa noastra completa profesorilor/educatorilor si scolilor afectate de închiderea datorata COVID-19."
#    click_here: "Click aici"
#    creativity_rigor_title: "Unde Creativitatea se intalneste cu Rigoarea"
#    creativity_rigor_subtitle1: "Faceti scrierea codului sursa distractiva si invatati abilitati din lumea reala"
#    creativity_rigor_blurb1: "Elevii tasteaza coduri Python si JavaScript reale in timp ce joaca jocuri care incurajeaza incercarea si eroarea, gandirea critica si creativitatea. Elevii aplica apoi abilitatile de codare pe care le-au invatat dezvoltandu-si propriile jocuri si site-uri web in cursuri bazate pe proiecte."
#    creativity_rigor_subtitle2: "Ajungeti elevii/studentii la nivelul lor"
#    creativity_rigor_blurb2: "Fiecare nivel CodeCombat este dezvoltat pe baza a milioane de puncte de date si optimizat pentru a se adapta fiecarui cursant. Nivelurile de practica si sugestii ii ajuta pe elevi cand se blocheaza, iar nivelurile de provocare evalueaza invatarea elevilor pe tot parcursul jocului."
#    creativity_rigor_subtitle3: "Construit pentru toti profesorii, indiferent de experienta"
#    creativity_rigor_blurb3: "Curricula CodeCombat, in ritm propriu, conform standardelor, face posibila predarea informaticii pentru toata lumea. CodeCombat ofera profesorilor pregatire, resurse de instruire si sprijin dedicat pentru a se simti increzatori si de succes în clasa."
#    featured_partners_title1: "Prezentat in"
#    featured_partners_title2: "Premii si Parteneri"
#    featured_partners_blurb1: "Furnizor aprobat de CollegeBoard"
#    featured_partners_blurb2: "Cel mai creativ instrument pentru elevi si studeni"
#    featured_partners_blurb3: "Alegerea de Top pentru invatare"
    featured_partners_blurb4: "Partener oficial Code.org"
#    featured_partners_blurb5: "Membru oficial CSforAll"
#    featured_partners_blurb6: "Partener de Activitate Hour of Code"
#    for_leaders_title: "Pentru liderii scolii"
#    for_leaders_blurb: "Un program de informatica cuprinzator, conform standardelor"
    for_leaders_subtitle1: "Implementare ușoară"
#    for_leaders_subblurb1: "Un program bazat pe web care nu necesita suport IT. Incepeti in mai putin de 5 minute folosind Google sau Clever Single Sign-On (SSO)."
#    for_leaders_subtitle2: "Programa completa de scriere cod"
